...
class HackerNewsScraper {
  ...
  _isValidPost(post) {
    return this._isValidString(post.title) &&
      this._isValidString(post.author) &&
      validUrl.isUri(post.uri) &&
      this._isNonNegativeInteger(post.rank) &&
      this._isNonNegativeInteger(post.points) &&
      this._isNonNegativeInteger(post.comments);
  }
